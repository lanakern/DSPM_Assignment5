...
func_venues <- function(country, size, api_key) {
  ...
  for (i in 0:loop_pages) {
    ...
    # respect rate limit: 5 requests per second
    # using Sys.sleep(0.2) the for loop stopped yielding the HTTP error 429
    # meaning that I sent to much requests. Thus, I use a more conservative rate 
    # limit of 2 seconds beteeen each request.
    Sys.sleep(2)
